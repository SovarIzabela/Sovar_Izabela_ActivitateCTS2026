...
public class TunningOffRoad extends AMasina{

    public TunningOffRoad(String marca, String sasiu, List<String> listaServiciiTunning) {
        this.marca = marca;
        this.sasiu = sasiu;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("TunningOffRoad{");
